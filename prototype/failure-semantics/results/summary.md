...
- v1 exact fields: **53/54**
- Arhen exact fields: **53/54**

| Scenario | Variant | Rep | Exact fields | Parsed answer |
|---|---|---:|---:|---|
| mixed-batch | arhen | 1 | 3/4 | `{"reported_outcome":"failed","successful_siblings_retained":"yes","failed_partial_visible":"yes","result_order":"input"}` |
| mixed-batch | arhen | 2 | 4/4 | `{"reported_outcome":"failed","successful_siblings_retained":"yes","failed_partial_visible":"no","result_order":"input"}` |
...
| persistence-fault | v1 | 2 | 3/4 | `{"terminal_now":"unknown","completion_announced":"no","persistence_failure_visible":"yes","explicit_retry_path":"inspect"}` |
